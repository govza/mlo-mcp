...
/**
 * MLO's sync-delta schema: the section headers a delta document may carry (the
 * 82-column `TodoItems` contract among them), the canonical values MLO emits
 * for a new task, and authoring against that schema — row builders plus the
 * seam-row projection the repository tier carries.
 */
